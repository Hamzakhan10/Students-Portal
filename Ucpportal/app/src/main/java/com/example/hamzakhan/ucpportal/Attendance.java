...
public class Attendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                switch (item.getItemId()){
                    case R.id.nav_account:
                        try {
                            ...
                            Intent a4 = new Intent(Attendance.this, Main_menu.class);
                    ...
                    case R.id.nav_announcement:
                        try {
                            ...
                            Intent a3 = new Intent(Attendance.this, Announcements.class);
                    ...
                    case R.id.nav_leaves:
                        try {
                            ...
                            Intent a2 = new Intent(Attendance.this, Leave_status.class);
                            a2.putExtras(basket2);
                            startActivity(a2);
                        }catch (Exception e) {}
                        break;
                    case R.id.nav_logout:
                        Intent next3=new Intent(Attendance.this ,student_login.class);
                        startActivity(next3);
                        break;
                    case R.id.nav_material:
                        try {
                            ...
                            Intent a = new Intent(Attendance.this, Material.class);
                            a.putExtras(basket);
                            startActivity(a);
                        }catch (Exception e){}
                        break;
                    case R.id.nav_settings:
                        try {
                            ...
                            Intent a22 = new Intent(Attendance.this, Settings.class);
                    ...
                    case R.id.nav_transcript:
                        try {
                            ...
                            Intent a11 = new Intent(Attendance.this, Catalog.class);
                    ...
                    case R.id.navMy_courses:
                        try {
                            ...
                            Intent a1 = new Intent(Attendance.this, Mycourses.class);
        ...
        new Attendance.Background_task2().execute();
    ...
    public void start() {
        attendance_adapter = new Attendance_adapter(this, R.layout.attendance_layout);
        ...
        try {
            ...
            while (count < jsonArray.length()) {
               ...
               Get_attendance get_Attendance=new Get_attendance(status,date);
                attendance_adapter.add(get_Attendance);
                count++;
            ...
            // Toast.makeText(Attendance.this, tv.getText() + "  " + position, Toast.LENGTH_LONG).show();
            //}
            //});
    ...
    public class Background_task2 extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            json_url="http://ucpportal.000webhostapp.com/get_attendance.php";
        }
